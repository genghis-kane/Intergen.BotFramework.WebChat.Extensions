...
export class Icon extends React.Component {    
    public render() {
        return (
            <span id='webchatOpenContainer' className='webchat-open-container'> 
                <svg id='webchatOpenIcon' aria-hidden='true' data-prefix='far' data-icon='comment-alt' className='webchat-open-icon svg-inline--fa fa-comment-alt fa-w-16' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
